...
public:
	...
	static const float RANGE_ANGLE_MIN = (-30.0*M_PI)/180.0;
	static const float RANGE_ANGLE_MAX = (30.0*M_PI)/180.0;
...
roomba::roomba() 
{
	pub = n.advertise<geometry_msgs::Twist>("robot_1/cmd_vel", 1000);
	sub = n.subscribe("robot_1/base_scan", 1000, &roomba::laserCallback, this);
}
